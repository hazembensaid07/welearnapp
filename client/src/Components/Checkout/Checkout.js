      ...
      <div>
              ...
              <div className="col-lg-8 col-xl-8">
                <div className="title-block">
                  ...
                  <ul className="list-inline mb-0">
                    ...
                    <li className="list-inline-item">checkout</li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        <main className="site-main woocommerce single single-product page-wrapper">
          ...
          <section className="space-3">
            <div className="container">
              <div className="row">
                <section id="primary" className="content-area col-lg-12">
                      ...
                      <div className="entry-content">
                        <div className="woocommerce">
                          ...
                          <form
                            name="checkout"
                            method="post"
                            className="checkout woocommerce-checkout row"
                            action="#"
                                ...
                                <div className="col-12">
                                  <div className="woocommerce-billing-fields">
                                    ...
                                    <div className="woocommerce-billing-fields__field-wrapper">
                                      <p
                                        className="form-row form-row-first form-group validate-required"
                                      ...
                                      >
                                        ...
                                        <span className="woocommerce-input-wrapper">
                                          <input
                                            type="text"
                                            className="input-text form-control input-lg"
                                      ...
                                      <p
                                        className="form-row form-row-last form-group validate-required"
                                      ...
                                      <p
                                        className="form-row form-row-wide form-group"
                                      ...
                                      <p
                                        className="form-row form-row-wide address-field update_totals_on_change form-group single-country validate-required"
                                      ...
                                      >
                                        ...
                                        <span className="woocommerce-input-wrapper">
                                          <select
                                            ...
                                            id="billing_country"
                                            className="country_to_state country_select select2-hidden-accessible form-control"
                                      ...
                                      <p
                                        className="form-row form-row-wide address-field form-group validate-required"
                                      ...
                                      <p
                                        className="form-row form-row-wide address-field form-group"
                                      ...
                                      <p
                                        className="form-row form-row-wide address-field form-group validate-required validate-state"
                                      ...
                                      >
                                        ...
                                        <span className="woocommerce-input-wrapper">
                                          <select
                                            name="billing_state"
                                            id="billing_state"
                                            className="state_select form-control input-lg select2-hidden-accessible"
                                            data-plugin="select2"
                                      ...
                                      <p
                                        className="form-row form-row-wide address-field form-group validate-postcode"
                                      ...
                                      <p
                                        className="form-row form-row-wide form-group validate-required validate-phone"
                                      ...
                                      <p
                                        className="form-row form-row-wide form-group validate-required validate-email"
                                ...
                                >
                                  ...
                                  <div className="form-row place-order">
                                    <noscript>
                                      ...
                                      the amount stated above if you fail to do
                                      so. &lt;br/&gt; &lt;button type="submit"
                                      class="button alt"
                                      name="woocommerce_checkout_update_totals"
